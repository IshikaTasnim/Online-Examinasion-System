    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="signin.php">Admin Panel</a>
        </div>
           ...
           <?php if(is_admin_Loggedin()):?>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="course_assign.php">Assign Course For Teacher</a></li>
                <li><a href="set_final_examineer.php">Set Final Examineer</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="create_new_semester.php">Create Semester</a></li>
                <li><a href="subject.php">Create Subject</a></li>
              </ul>
            </li>
            <?php else:?>
