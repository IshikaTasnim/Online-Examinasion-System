...
<div class="container fluid">
	...
	<h3>
		&nbsp&nbspQuestions have  been set for 
		<?php
	...
	<?php
		$i = 1 ;
		$query = $db->query("select * from finale_question inner join finale_exam on finale_question.fe_id=finale_exam.fe_id and t_id = '$t_id'");
